export default [
  ...
  },
  {
    ...
    content:
      "Red3Media a full service marketing agency, so my day to day work involved everything from building WordPress sites to creating designs for print to managing social media accounts. I also got to learn about mobile app development while I built iOS apps, like the flybot.com domain search."
  },
  {
    date: "2010-2013",
    ...
    content:
      "CardWeb.com was a portal and newsletter for financial news that's been around since the 80s. I helped work on the first major redesign in over 20 years. It was a massive 3 year project that involved building a custom PHP MVC framework, setting up a PostgreSQL database, and designing a new subscriber website. After getting the portal built, I worked closely with companies like Discover, Visa, and American Express to help implement our new API endpoints into their in-house employee portals."
  },
  {
    date: "2008-Current",
    title: "mediachicken",
